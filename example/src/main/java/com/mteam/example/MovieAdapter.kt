...
class MovieAdapter(
    private val wathclistListener: WatchlistListener,
    private val onDoggoClickListener: ((view: View, movie: MovieModel) -> Unit)? = null
) :
    ...
    override fun onBindViewHolder(holder: MovieViewHolder, position: Int) {
        ...
        with(holder.posterImageView) {
            transitionName = movie.posterLink
