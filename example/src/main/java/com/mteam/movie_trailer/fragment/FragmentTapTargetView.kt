...
import com.mteam.base_ui.taptargetview.TapTargetSequence
import com.mteam.base_ui.taptargetview.TapTargetView
import com.mteam.movie_trailer.R
import kotlinx.android.synthetic.main.target_view_fragment.*

class FragmentTapTargetView : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.target_view_fragment, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Load our little droid guy
        val droid = ContextCompat.getDrawable(context!!, R.drawable.ic_android_black_24dp)
        // Tell our droid buddy where we want him to appear
        // Tell our droid buddy where we want him to appear
        val droidTarget = Rect(
            0,
            0,
            droid!!.intrinsicWidth * 2,
            droid!!.intrinsicHeight * 2
        )
        ...
        val spannedDesc =
            SpannableString("This is the sample app for TapTargetView")
        spannedDesc.setSpan(
            UnderlineSpan(),
        ...
        TapTargetView.showFor(activity!!,
            TapTarget.forView(fab, "Hello, world!", spannedDesc)
                .cancelable(false)
                .drawShadow(true)
